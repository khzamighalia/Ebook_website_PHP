...
<div class="row">
    ...
    <hr class=hr1>
          ...
          <input type="text" name="email" class="no2">
          <h3>Changer le mot de passe</h3>
          <br>
          <label>Ancien mot de passe</label><br>
          <input type="password" name="password" class="no2"><br>
          <div class="row nnn2 ">
          <div class="col-md-6" >
          ...
          <div class="row">
          <div class="col-md-6" >
          <button class="confirm"><i class="fas fa-edit"></i> Modifier les détails</button>
</div>
      </div>
</div>
</div>
